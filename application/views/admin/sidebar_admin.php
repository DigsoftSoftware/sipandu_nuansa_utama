      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= site_url('dashboard/admin/view'); ?>" aria-expanded="false">
                <i class="ti ti-user-shield"></i>
                <span class="hide-menu">Data Admin</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= site_url('dashboard/kaling/view'); ?>" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= site_url('dashboard/wilayah/view'); ?>" aria-expanded="false">
                <i class="ti ti-map"></i>

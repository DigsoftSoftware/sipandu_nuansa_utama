    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button type="button" class="btn btn-primary" onclick="window.location.href='<?= base_url('dashboard/penghuni/create_admin') ?>'">
                Tambah Pendatang
                </button>
            </div>
                        ...
                        <?php foreach ($penghuni_diproses as $i => $p): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('dashboard/penghuni/detail_admin/' . $p->uuid) ?>"
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive mt-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title fw-semibold mb-4">Data Terverifikasi</h5>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="<?= base_url('dashboard/penghuni/edit_admin/' . $p->uuid) ?>"
                ...
                success: function(response) {
                    if (response && Array.isArray(response)) {
                        ...
                        response.forEach((p, index) => {
                            const formattedTanggalMasuk = new Date(p.tanggal_masuk).toLocaleDateString('id-ID');
                            const formattedTanggalKeluar = p.tanggal_keluar ? new Date(p.tanggal_keluar).toLocaleDateString('id-ID') : '-';

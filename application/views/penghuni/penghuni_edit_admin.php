...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?= base_url('dashboard/penghuni/update_admin/' . $penghuni->uuid) ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                       ...
                       <div class="mb-3">
                            ...
                            <select id="tujuan-select" class="form-select" required>
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            ...
                            <select name="penanggung_jawab_id" id="penanggung_jawab_id" class="form-select" required>
                                ...
                                <?php foreach ($pj as $p): ?>
                                    <option value="<?= $p->id ?>" <?= $penghuni->penanggung_jawab_id == $p->id ? 'selected' : '' ?>><?= $p->nama_pj ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
